  ...
  makeTwix = function(moment) {
    ...
    Twix = (function() {
      function Twix(start, end, parseFormat, options) {
        ...
        this._trueEnd = this.allDay ? this.end.clone().endOf("day") : this.end;
        this._trueEndDiffable = this.allDay ? this.end.clone().add(1, "day") : this.end;
      }
      ...
      Twix.prototype.length = function(period) {
        return this._trueEndDiffable.diff(this._trueStart, period);
      };
      ...
      Twix.prototype._inner = function(period, intervalAmount) {
        ...
        end = this._trueEndDiffable.clone();
